...
def process_fav_folder(uid, fav_list_index):
    ...
    fav_folder_content_list += handle_jobject_per_page(video_jobject, fav_list_index, 1)
    ...
    for i in range(2, page_count + 1):
        ...
        responed_jobject = json.loads(resp)
        video_jobject = responed_jobject['data']['archives']
        fav_folder_content_list += handle_jobject_per_page(video_jobject, fav_list_index, i)
...
def handle_jobject_per_page(page_jobjects, fav_list_index, page_index):
    ...
    for i in range(0, len(page_jobjects)):
        ...
        return_dist["av_id"] = jObject['aid']
        return_dist["fav_name"] = fav_name_list[fav_list_index]
